(function ($) {
    ...
    function U(a) {
        ...
        this.anims = {};
        if (a.anims)
            for (b in a.anims) a.anims.hasOwnProperty(b) && (this.anims[b] = a.anims[b], this.anims[b].manager = this);
        this.activeAnims = []
    }
    ...
    function s(a) {
        ...
        this.scaleY = b.hasOwnProperty("scaleY") ? b.scaleY :
            1;
        this.opacity = b.hasOwnProperty("opacity") ? b.opacity : 1;
    ...
    function E(a) {
        ...
        b.hasOwnProperty("scale") && (this.scaleX = this.scaleY =
            b.scale);
    ...
    function V(a) {
        ...
        this.imageScaleY = b.imageScaleY || 1;
    ...
    function m(a) {
        ...
        this.applyFromOptions(a);
        this.eventMap = {};
        this.id = b.id || "button-" + m.IDPOOL++;
        this.state = m.states.UP;
        this.enabled = !0;
        b.clickFunction && this.addEventListener(m.events.CLICK, b.clickFunction)
    }
    ...
    function M(a) {
        ...
        this.textBaseline = b.textBaseline || "top";
        this.fillStyle = b.fillStyle ||
            "#000000";
        this.text = b.text || "";
        this.angle = b.angle || 0;
        this.scaleX = b.hasOwnProperty("scaleX") ? b.scaleX : 1;
    ...
    function H(a) {
        var b = new Image;
        b.preSrc = a;
        b.onload = H.imgOnLoad;
        b.onerror = H.imgOnError;
        b.alreadyLoaded = !1;
        b.load = function (a, b) {
    ...
    function P(a) {
        ...
        this.verticalAlign = b.verticalAlign || "middle";
        this.width = b.width || 0;
        this.height =
            b.height || 0;
    ...
    function W(a) {
        ...
        this.flappyNumbersBestScore = new P({
            x: 520,
            y: 210,
            horizontalAlign: "right",
            verticalAlign: "top",
    ...
    function F(a) {
        ...
        this.soundsError = this.soundsCount =
            this.soundsLoaded = 0
    }
    ...
    function C(a) {
        ...
        this.interstitialMobileSlotName = a.interstitialMobileSlotName;
        this.interstitialDesktopSlotName = a.interstitialDesktopSlotName;
        this.enabled = this.interstitialStarted = !1;
        g.googletag && googletag.pubads && this.interstitialScreen && (this.enabled = !0);
    ...
    function X(a) {
        ...
        this.pipeFullTopSprite =
            b.pipeFullTopSprite.copy();
    ...
    function d() {
        ...
        this.numPlays = this.fixedAccumulator = this.frameCount = this.lastMainLoopTime = 0;
        this.logicLooping = this.looping = this.started = !1;
        this.state = d.states.none;
        this.changingState = !1;
        this.score = 0;
        this.bestScore = parseInt(Y.getCookie(d.BESTSCORECOOKIE, "0"), 10);
        this.debug = this.kikEnabled = this.allLoaded = this.ignoreMouseDown = !1;
        this.debugStuff = {
            lastFrameCapture: 0,
        ...
        this.mouseManager = new p({
            element: r.get("touchOverlay")
        });
        this.buttonManager = new A;
        this.imgManager = new z({
            images: d.IMGS
        });
        this.soundManager = new F({
            sounds: d.SOUNDS
        });
        this.animManager = new U;
        this.loadingStage = new s({
            x: 0,
            y: 0,
            scaleX: this.scaleX,
            scaleY: this.scaleY
        });
        this.progressBg = new K({
            x: 0,
            y: d.BASEHEIGHT / 2 - 25,
            width: d.BASEWIDTH,
            height: 50,
        ...
        this.appCacheManager = new x({
            appCache: g.applicationCache,
            reloadOnNewUpdate: !0
        });
        this.adManager = new C({
            interstitialScreen: r.get("adInterstitialScreen"),
            interstitialMobileSlotName: "iiMedRec",
            interstitialDesktopSlotName: "iiDesktop",
        ...
        (function () {
            for (var a = 0, b = ["webkit", "moz"], e = 0; e < b.length && !g.requestAnimationFrame; ++e) g.requestAnimationFrame = g[b[e] + "RequestAnimationFrame"], g.cancelAnimationFrame = g[b[e] + "CancelAnimationFrame"] || g[b[e] + "CancelRequestAnimationFrame"];
            g.requestAnimationFrame || (g.requestAnimationFrame = function (b, e) {
    ...
    (function () {
        ...
        b.addEventListener = function (a, b, n) {
            var y;
            y = n ? this._captureListeners = this._captureListeners || {} : this._listeners =
                this._listeners || {};
            var c = y[a];
            return c && this.removeEventListener(a, b, n), c = y[a], c ? c.push(b) : y[a] = [b], b
        };
        b.on = function (a, b, n, y, c, d) {
            return b.handleEvent && (n = n || b, b = b.handleEvent), n = n || this, this.addEventListener(a, function (a) {
                b.call(n, a, c);
                y && a.remove()
            }, d)
        };
        b.removeEventListener = function (a, b, n) {
            if (n = n ? this._captureListeners : this._listeners) {
                var c = n[a];
                if (c)
                    for (var d = 0, u = c.length; u > d; d++)
                        if (c[d] == b) {
                            1 == u ? delete n[a] : c.splice(d, 1);
                            break
                        }
            }
        };
        ...
        b.dispatchEvent = function (a, b) {
            ...
            if (a.target = b || this, a.bubbles && this.parent) {
                for (var c = this, n = [c]; c.parent;) n.push(c = c.parent);
                for (var d = n.length, c = d - 1; 0 <= c && !a.propagationStopped; c--) n[c]._dispatchEvent(a, 1 + (0 == c));
                for (c = 1; d > c && !a.propagationStopped; c++) n[c]._dispatchEvent(a,
                    3)
        ...
        b._dispatchEvent = function (a, b) {
            var n, c = 1 == b ? this._captureListeners : this._listeners;
            if (a && c && (c = c[a.type]) && (n = c.length)) {
                a.currentTarget = this;
                a.eventPhase = b;
                a.removed = !1;
                for (var c = c.slice(),
                        d = 0; n > d && !a.immediatePropagationStopped; d++) {
                    var u = c[d];
                    u.handleEvent ? u.handleEvent(a) : u(a);
                    a.removed && (this.off(a.type, u, 1 == b), a.removed = !1)
                }
            }
        };
    ...
    this.createjs = this.createjs || {};
    (function () {
        var a = function (a, b, n) {
            this.initialize(a, b, n)
        }, b = a.prototype;
        b.type = null;
        b.target = null;
    ...
    (function () {
        ...
        a.registerPlugin = function (b) {
            try {
                R.log("createjs.Sound.registerPlugin has been deprecated. Please use registerPlugins.")
            } catch (e) {}
            return a._registerPlugin(b)
        };
        a._registerPlugin = function (b) {
            return a._pluginsRegistered = !0, null == b ? !1 : b.isSupported() ?
                (a.activePlugin = new b, !0) : !1
        };
        ...
        a.getCapability = function (b) {
            return null == a.activePlugin ?
                null : a.activePlugin._capabilities[b]
        };
        ...
        a.registerSound = function (e, f, c, d, g) {
            ...
            g = null;
            null != c && (isNaN(c.channels) ? isNaN(c) || (g = parseInt(c)) :
                g = parseInt(c.channels));
        ...
        a._parsePath =
            function (b, e, f, c) {
                ...
                if (1 < b.length) try {
                    R.log('createjs.Sound.DELIMITER "|" loading approach has been deprecated. Please use the new alternateExtensions property.')
                } catch (d) {}
                e = {
                    type: e || "sound",
                    id: f,
        ...
        a._generateCapabilities = function () {
            if (null == a._capabilities) {
                ...
                for (var f = createjs.Sound.SUPPORTED_EXTENSIONS, c = createjs.Sound.EXTENSION_MAP, d = 0, h = f.length; h > d; d++) {
                    var u = f[d],
                        k = c[u] || u;
                    a._capabilities[u] = "no" != b.canPlayType("audio/" + u) && "" != b.canPlayType("audio/" + u) || "no" != b.canPlayType("audio/" + k) && "" != b.canPlayType("audio/" + k)
                }
    ...
    (function () {
        ...
        b._cleanUp = function () {
            ...
            D(this._delayTimeoutId);
            D(this._soundCompleteTimeout);
            this._startTime = 0;
        ...
        b._handleSoundReady = function () {
            if (null != g.createjs) {
                ...
                this._soundCompleteTimeout = G(this._endedHandler, 1E3 * (a - this._offset));
        ...
        b.pause = function () {
            return this._paused || this.playState != createjs.Sound.PLAY_SUCCEEDED ? !1 : (this._paused = !0, this._offset = this._owner.context.currentTime - this._startTime, this._cleanUpAudioNode(this.sourceNode), this._cleanUpAudioNode(this._sourceNodeNext), 0 != this.gainNode.numberOfOutputs && this.gainNode.disconnect(), D(this._delayTimeoutId), D(this._soundCompleteTimeout), !0)
        };
        b.resume = function () {
        ...
        b.setPosition = function (a) {
            return this._offset = a / 1E3, this.sourceNode && this.playState == createjs.Sound.PLAY_SUCCEEDED && (this._cleanUpAudioNode(this.sourceNode), this._cleanUpAudioNode(this._sourceNodeNext), D(this._soundCompleteTimeout)),
    ...
    (function () {
        ...
        a._generateCapabilities = function () {
            if (null == a._capabilities) {
                var b = a.tag = q.createElement("audio");
                if (null == b.canPlayType) return null;
                a._capabilities = {
                    panning: !0,
                    volume: !0,
        ...
        b.register = function (a, b) {
            ...
            for (var c = createjs.HTMLAudioPlugin.TagPool.get(a), d = null, h = b || this.defaultNumChannels, g = 0; h > g; g++) d = this._createTag(a), c.add(d);
    ...
    (function () {
        ...
        b.play = function (a, b, e, c, d, h) {
            this._cleanUp();
            createjs.Sound._playInstance(this, a, b, e, c, d, h)
        };
        ...
        b.pause = function () {
            return this._paused ||
                this.playState != createjs.Sound.PLAY_SUCCEEDED || null == this.tag ? !1 : (this._paused = !0, this.tag.pause(), D(this._delayTimeoutId), !0)
        };
        b.resume = function () {
    ...
    (function () {
        ...
        b.get = function () {
            ...
            var a = this.tags.pop();
            return null ==
                a.parentNode && q.body.appendChild(a), a
        };
        b.set = function (a) {
    ...
    (function () {
        ...
        c.addClass = function (a, b) {
            var e = a.hasOwnProperty("className"),
                ...
                d = [],
                h = "object" === typeof b && "number" === typeof b.length ? b : [b],
                g;
            "string" === typeof c && 0 < c.length && (d = c.split(" "));
            for (g = 0; g < h.length; g += 1) c = h[g], -1 === d.indexOf(c) && d.push(c);
            e ? a.className =
        ...
        c.ajax = function (a) {
            if ("object" === typeof a && "string" === typeof a.url) {
                ...
                if (JSON && JSON.parse) {
                    ...
                    b.send()
                } else "string" === typeof a.jsonp && (f || (f = {}), f.callback = a.callback, d = c.objectToParamString(f), m = c.createScript(e + "?" + d), q.body.appendChild(m), G(function () {
        ...
        c.isPropertySupported = function (a) {
            var b = ["Webkit", "Khtml", "Moz", "O", "ms"],
                e = (q.body || q.documentElement).style,
        ...
        c.isMobile = {
            ...
            FirefoxOS: function () {
                return -1 == navigator.userAgent.indexOf("Android") && 0 <= navigator.userAgent.indexOf("Firefox") && 0 <= navigator.userAgent.indexOf("Mobile")
            },
            BlackBerry: function () {
            ...
            Safari: function () {
                return c.isMobile.iOS() && !c.isMobile.ChromeIOS() && navigator.userAgent.match(/AppleWebKit/i)
            },
            iPhoneSafari: function () {
                return (c.isMobile.iPhone() || c.isMobile.iPod()) && !c.isMobile.ChromeIOS() && navigator.userAgent.match(/AppleWebKit/i)
            },
            ChromeIOS: function () {
                return c.isMobile.iOS() &&
                    navigator.userAgent.match("CriOS")
            },
            ChromeAndroid: function () {
                return navigator.userAgent.match(/Android.+Chrome|CrMo/i)
            }
        };
        ...
        c.visibility = {
            ...
            addOnChange: function (a) {
                return this.isSupported() && -1 === this.mOnChangeFunctions.indexOf(a) ? (q.addEventListener(this.mVisibilityChange, a, !1), !0) : !1
            },
            removeOnChange: function (a) {
                if (this.isSupported()) {
                    var b = this.mOnChangeFunctions.indexOf(a);
                    if (-1 !== b) return q.removeEventListener(this.mVisibilityChange, a), this.mOnChangeFunctions.splice(b, 1), !0
                }
                return !1
            },
            ...
            isHidden: function () {
                return this.isSupported() ? q[this.mHidden] : !1
            }
        };
    ...
    S.prototype = {
        get: function (a) {
            var b = this.map[a];
            b || (this.map[a] = b = q.getElementById(a));
            return b
        },
        create: function (a, b, e, c) {
            a = q.createElement(a);
            var d;
            b && (a.hasOwnProperty("id") ? a.id = b : a.setAttribute("id",
                b));
            e && (a.hasOwnProperty("className") ? a.className = e : a.setAttribute("class", e));
            if (c)
    ...
    v.prototype = {
        ...
        removeAllEventListeners: function (a) {
            if (this.eventMap[a]) {
                for (a = this.eventMap[a]; 0 < a.length;) a.pop();
                return !0
            }
            return !1
        },
    ...
    B.prototype = c.inherit(new v, {
        keyDown: function (a) {
            this.keyMap[a.keyCode] || (this.keyMap[a.keyCode] = !0, this.dispatch(B.events.DOWN, {
                keyCode: a.keyCode,
                keyMap: this.keyMap,
                originalEvent: a
            }))
        ...
        keyUp: function (a) {
            this.keyMap[a.keyCode] && (this.keyMap[a.keyCode] = !1, this.dispatch(B.events.UP, {
                keyCode: a.keyCode,
                keyMap: this.keyMap,
                originalEvent: a
            }))
    ...
    p.prototype = c.inherit(new v, {
        ...
        mouseDown: function (a) {
            ...
            this.dispatch(p.events.MOUSEDOWN, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
            ...
            0 < this.skipMouseDown ?
                this.skipMouseDown -= 1 : this.dispatch(p.events.DOWN, {
                    originalEvent: a,
                    x: this.mouseX,
                    y: this.mouseY,
                    scaledX: this.scaledMouseX,
        ...
        mouseMove: function (a) {
            ...
            a.stopPropagation();
            this.updateMousePos(a);
            this.dispatch(p.events.MOUSEMOVE, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
            ...
            0 === this.numTouch && this.dispatch(p.events.MOVE, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
        ...
        mouseUp: function (a) {
            ...
            a.stopPropagation();
            this.updateMousePos(a);
            this.dispatch(p.events.MOUSEUP, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
            ...
            0 < this.skipMouseUp ? this.skipMouseUp -= 1 : this.dispatch(p.events.UP, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
        ...
        mouseClick: function (a) {
            ...
            a.stopPropagation();
            this.updateMousePos(a);
            this.dispatch(p.events.MOUSECLICK, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
            ...
            0 === this.numTouch && this.dispatch(p.events.CLICK, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
        ...
        touchStart: function (a) {
            ...
            this.dispatch(p.events.TOUCHSTART, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
        ...
        touchMove: function (a) {
            ...
            a.stopPropagation();
            this.updateMousePos(a);
            this.dispatch(p.events.TOUCHMOVE, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
        ...
        touchEnd: function (a) {
            ...
            this.numTouch -= 1;
            this.skipMouseUp += 1;
            this.dispatch(p.events.TOUCHEND, {
                originalEvent: a,
                x: this.mouseX,
                y: this.mouseY,
                scaledX: this.scaledMouseX,
    ...
    T.prototype = {
        ...
        setCookie: function (a, b, e) {
            ...
            c.setSeconds(c.getSeconds() +
                e);
            q.cookie = a + "=" + b + "; expires=" + c.toUTCString();
            this.cookieMap[a] = b
        },
        parseCookies: function () {
            return q.cookie.split(";").map(function (a) {
                return a.trim().split("=")
            }).reduce(function (a, b) {
                a[b[0]] = b[1];
                return a
    ...
    x.prototype = c.inherit(new v, {
        init: function () {
            if (this.appCache)
                if (this.appCache.status === this.appCache.UNCACHED) this.loadNormally();
                else {
                    this.appCache.addEventListener("noupdate",
                        c.bindFnc(this, this.loadNormally), !1);
                    this.appCache.addEventListener("obsolete", c.bindFnc(this, this.loadNormally), !1);
                    this.appCache.addEventListener("error", c.bindFnc(this, this.loadNormally), !1);
                    this.appCache.addEventListener("cached", c.bindFnc(this, this.loadNormally), !1);
                    this.appCache.addEventListener("downloading", c.bindFnc(this, this.updatingCache), !1);
                    this.appCache.addEventListener("progress", c.bindFnc(this, this.updateProgress), !1);
                    this.appCache.addEventListener("updateready", c.bindFnc(this, this.updateReady), !1);
                    try {
        ...
        loadNormally: function (a) {
            this.finished || (this.finished = !0, this.dispatch(x.events.LOADNORMALLY, {
                appCache: this.appCache,
                originalEvent: a
            }))
        },
        updateProgress: function (a) {
            this.finished || this.dispatch(x.events.UPDATEPROGRESS, {
                appCache: this.appCache,
                originalEvent: a,
        ...
        updatingCache: function (a) {
            this.finished || this.dispatch(x.events.UPDATINGCACHE, {
                appCache: this.appCache,
                originalEvent: a
            })
        },
        updateReady: function (a) {
            this.finished || (this.finished = !0, this.dispatch(x.events.UPDATEREADY, {
                appCache: this.appCache,
                originalEvent: a
    ...
    Q.prototype = c.inherit(new k, {
        ...
        step: function (a, b) {
            ...
            if (this.currentIndex < this.anims.length) {
                var e, c;
                do e = this.anims[this.currentIndex], c = !1, e && (e.prepared || e.start(e.startTime), b >= e.startTime && b < e.endTime ? (c = (b - e.startTime) / e.duration, e.step(c, b), c = !1) : b >= e.endTime && (e.step(1, b),
                    e.end(), this.currentIndex += 1, c = !0)); while (c)
            }
        },
        end: function () {
    ...
    I.prototype = c.inherit(new k, {
        ...
        start: function (a) {
            var b;
            k.prototype.start.call(this, a);
            for (b = 0; b < this.anims.length; b +=
                1) this.anims[b].start(a)
        },
        step: function (a, b) {
            var c;
            k.prototype.step.call(this, a, b);
    ...
    U.prototype = c.inherit(new v, J.prototype, {
        addAnim: function (a) {
            this.anims[a.id] = a;
            a.manager = this
        },
        removeAnim: function (a) {
            if (a = this.anims["string" === typeof a ?
                a : a.id]) this.anims[a.id] = void 0, a.manager = null
        },
    ...
    K.prototype = c.inherit(new h, w.prototype, {
        draw: function (a) {
    ...
    L.prototype = c.inherit(new E, {
        ...
        applyFromOptions: function (a) {
            ...
            if (this.frameMap)
                if (this.currentFrameId) this.setFrameId(this.currentSpriteId);
                else
                    ...
                    } else this.sourceRect = b.rect || new h
        }
    });
    m.IDPOOL = 0;
    m.states = {
    ...
    m.prototype = c.inherit(new L, v.prototype, {
        click: function (a) {
            this.enabled && this.dispatch(m.events.CLICK, {
                originalEvent: a
            })
        },
        down: function (a) {
            this.enabled && (this.setState(m.states.DOWN), this.dispatch(m.events.DOWN, {
                originalEvent: a
            }))
        },
        up: function (a) {
            this.enabled && (this.setState(m.states.UP), this.dispatch(m.events.UP, {
                originalEvent: a
            }))
        },
        hover: function (a) {
            this.enabled && (this.setState(m.states.HOVER), this.dispatch(m.events.HOVER, {
                originalEvent: a
            }))
        },
        setEnabled: function (a) {
            (this.enabled = a) ? this.setState(m.states.UP) : this.setState(m.states.DISABLED)
        },
        setState: function (a) {
            this.state = a;
            this.anchorY = this.state === m.states.DOWN ? -5 : 0
        },
    ...
    M.prototype = c.inherit(new w, {
        draw: function (a) {
            this.visible && 0 < this.opacity && (a.save(), 1 >
                this.opacity && (a.globalAlpha = this.opacity), a.translate(this.x, this.y), a.rotate(this.angle), a.scale(this.scaleX, this.scaleY), a.textAlign = this.textAlign, a.textBaseline = this.textBaseline, a.fillText(this.text, -this.anchorX, -this.anchorY), a.restore())
        }
    });
    t.gaEvents = {
    ...
    t.prototype = {
        init: function () {
            ...
            this.game.buttonManager.addEventListener(A.events.CLICK, c.bindFnc(this, this.onButtonClick));
            this.game.addEventListener(d.events.stateChanged, c.bindFnc(this, this.onStateChange));
            this.game.adManager.addEventListener(C.events.INTERSTITIALSHOWN, c.bindFnc(this, this.interstitialShown));
            this.game.adManager.addEventListener(C.events.INTERSTITIALHIDDEN, c.bindFnc(this, this.interstitialHidden))
        },
        interstitialShown: function (a) {
            this.gaAdEvent(t.gaEvents.INTERSTITIAL_SHOWN,
                c.isMobile.any() ? "ad-mobile" : "ad-desktop")
        },
        interstitialHidden: function (a) {
            this.gaAdEvent(t.gaEvents.INTERSTITIAL_HIDDEN, c.isMobile.any() ? "ad-mobile" : "ad-desktop")
        },
        gameInitted: function (a) {
            this.game.kikEnabled && this.gaSetCurrentPage("/?kik=true", q.title);
            this.gaPageView()
        },
        onStateChange: function (a) {
            if (a && a.data && a.data.state) {
                ...
                case d.states.showingBoard:
                    this.gaGameplayEvent(t.gaEvents.ENDGAME), b ?
                        this.gaLevelFirstPlayEvent(t.gaEvents.PASS_TUBE, this.game.kikEnabled ? "kik-tube-" + this.game.score : "nonkik-tube-" + this.game.score) : this.gaLevelReplayEvent(t.gaEvents.PASS_TUBE, this.game.kikEnabled ? "kik-tube-" + this.game.score : "nonkik-tube-" + this.game.score);
                        // window.location.href="objc://"+"sendScore"+":/"+this.game.score;
                }
            }
        },
        onButtonClick: function (a) {
            ...
            case "mainMenuPlayButton":
                this.gaButtonEvent(t.gaEvents.PLAYBUTTON, this.game.kikEnabled ? "playbutton_kik" : "playbutton_nonkik");
                break;
            case "gameOverPlayButton":
                this.gaButtonEvent(t.gaEvents.REPLAY,
                    this.game.kikEnabled ? "replay_kik" : "replay_nonkik");
                break;
            case "kikButton":
                this.gaButtonEvent(t.gaEvents.SHARE_KIK);
                break;
            case "gameOverTweetButton":
                this.gaButtonEvent(t.gaEvents.SHARE_TW);
                break;
            case "gameOverFBButton":
                this.gaButtonEvent(t.gaEvents.SHARE_FB)
            }
        },
        gaPageLoadEvent: function (a, b, c) {
            this.gaSend({
                hitType: "event",
        ...
        gaLevelFirstPlayEvent: function (a, b, c) {
        ...
        gaEvent: function (a, b, c, d) {
            g.ga && ga("send", "event", a, b, c, d)
        },
        gaPageView: function (a) {
            g.ga &&
                (a = a ? c.extendObj(this.pageObj, a) : this.pageObj, ga("send", "pageview", a))
        },
    ...
    O.createCombinedId = function (a, b) {
    ...
    O.prototype = {
        getSprite: function (a) {
            ...
            b || (b = new L(c.inherit(this.spriteMap[a], {
                    image: this.image
                })), this.sprites[a] =
                b);
            return b
        ...
        getCanvas: function (a, b) {
            var c, d = O.createCombinedId(a, b);
            c = this.canvases[d];
        ...
        createCanvas: function (a, b) {
            var c = b || {}, d = a.left || a.x || 0,
                ...
                h = a.right || 0,
                k = a.bottom || 0,
                l = q.createElement("canvas"),
                m = l.getContext("2d"),
                p = c.scaleX || 1,
                r = c.scaleY || 1;
            a.width && (h = d + a.width);
            a.height && (k = g + a.height);
            c.hasOwnProperty("scale") && (p = r = c.scale);
            c = h - d;
            k -= g;
            l.width = c * p;
            l.height = k * r;
    ...
    P.prototype = c.inherit(new s, {
        ...
        updateNumber: function () {
            var a, b, e = c.getDigits(this.number),
                d = [],
                g = 0,
                h = 0,
                k = 0,
    ...
    W.prototype = c.inherit(new s, {
        ...
        postAnim: function () {
            10 > this.score ? this.hideMedal() :
                (this.showMedal(), 10 <= this.score && 50 > this.score ? this.medalsSprite.setFrameId("bronze") : 50 <= this.score && 100 > this.score ? this.medalsSprite.setFrameId("silver") : 100 <= this.score && this.medalsSprite.setFrameId("gold"));
    ...
    z.prototype = c.inherit(new v, {
        startLoading: function () {
            var a, b = c.bindFnc(this, this.imageLoaded),
                e = c.bindFnc(this, this.imageErrored);
            for (a in this.imgListObj) this.imgListObj.hasOwnProperty(a) && (this.imgs[a] =
                this.imgs[this.imgListObj[a]] = new H(this.imgListObj[a]), this.imgCount += 1, this.imgs[a].imgName = a, this.imgs[a].load(b, e));
            0 === this.imgCount && this.dispatch(z.events.allImagesLoad, {
        ...
        imageLoaded: function (a) {
            this.imgLoaded += 1;
            this.dispatch(z.events.imageLoad, {
                img: a,
                loaded: this.imgLoaded,
                total: this.imgCount
            });
            this.imgLoaded >= this.imgCount && this.dispatch(z.events.allImagesLoad, {
                loaded: this.imgLoaded,
                total: this.imgCount
            })
        },
        imageErrored: function (a) {
            this.imgLoaded +=
                1;
            this.dispatch(z.events.imageError, {
                img: a,
                loaded: this.imgLoaded,
                total: this.imgCount
            })
    ...
    F.prototype = c.inherit(new v, {
        startLoading: function () {
            var a, b = [];
            for (a in this.soundMap) this.soundMap.hasOwnProperty(a) && (b.push({
                id: a,
                src: this.soundMap[a]
            }), this.soundsCount += 1, g.cordova && (this.cordovaSounds[this.soundMap[a]] = new Media("file:///android_asset/www/" + this.soundMap[a], function () {},
                function () {
                    R.log("Error while playing " + this.src)
                })));
            if (g.cordova)
        ...
        soundLoaded: function (a) {
            this.soundsLoaded += 1;
            this.dispatch(F.events.soundLoad, {
                loaded: this.soundsLoaded,
                total: this.soundsCount
            });
            this.soundsLoaded >= this.soundsCount && this.dispatch(F.events.allSoundsLoad, {
                loaded: this.soundsLoaded,
                total: this.soundsCount
            })
        },
        ...
        play: function (a) {
            this.enabled && (g.cordova ? this.cordovaSounds[a].play() : createjs.Sound.play(a))
        },
        stop: function (a) {
    ...
    A.prototype = c.inherit(new v, {
        addButton: function (a) {
            return -1 === this.buttons.indexOf(a) ? (this.buttons.push(a), !0) : !1
        },
        removeButton: function (a) {
            a = this.buttons.indexOf(a);
            return -1 !== a ? (this.buttons.splice(a,
                1), !0) : !1
        },
        onDown: function (a) {
            !this.downedButton && (this.downedButton = this.getButtonFromCoords(a.data.scaledX, a.data.scaledY)) && (this.hoveredButton = null, this.downedButton.down(), this.dispatch(A.events.DOWN, {
        ...
        onMove: function (a) {
            ...
            a = a.data.scaledY;
            if (this.downedButton) this.downedButton.state === m.states.UP && this.downedButton.contains(b, a) ? this.downedButton.down() : this.downedButton.state !== m.states.DOWN || this.downedButton.contains(b, a) || this.downedButton.up();
            else if (this.hoveredButton) this.hoveredButton.contains(b, a) || (this.hoveredButton.up(), this.dispatch(A.events.HOVEROUT, {
                button: this.hoveredButton
            }), this.hoveredButton = null);
            else if (b = this.getButtonFromCoords(b, a)) this.hoveredButton = b, b.hover(), this.dispatch(A.events.HOVERIN, {
                button: this.hoveredButton
            })
        },
        onUp: function (a) {
            this.downedButton && (this.downedButton.state === m.states.DOWN && (this.downedButton.click(), this.dispatch(A.events.CLICK, {
                button: this.downedButton
            })), this.downedButton.up(), this.dispatch(A.events.UP, {
                button: this.downedButton
            }), this.downedButton = null)
        },
        getButtonFromCoords: function (a, b) {
            var c;
    ...
    C.prototype = c.inherit(new v, {
        init: function () {
            this.interstitialScreen && c.addOnClick(this.interstitialScreen,
                c.bindFnc(this, function (a) {
                    var b = a.target;
        ...
        isInterstitialShowing: function () {
            return this.enabled && this.interstitialScreen ? c.hasClass(this.interstitialScreen, "show") : !1
        },
        refreshInterstitial: function () {
            if (this.enabled) {
                var a = g[this.getAdSlotName()],
                    b = !1;
                this.interstitialStarted ||
                    (c.isMobile.any() ? (c.addClass(this.interstitialScreen, "adMobile"), googletag.cmd.push(function () {
                    googletag.display("div-gpt-ad-1393968910515-0")
                })) : (c.addClass(this.interstitialScreen, "adDesktop"), googletag.cmd.push(function () {
                    googletag.display("div-gpt-ad-1393896859127-0")
                })), b = this.interstitialStarted = !0);
                a && !b && (googletag.pubads().refresh([a]), this.dispatch(C.events.INTERSTITIALREFRESHED))
            }
        },
        showInterstitial: function (a) {
            this.enabled && (this.hideCallback = a, c.addClass(this.interstitialScreen, "show"),
                this.dispatch(C.events.INTERSTITIALSHOWN))
        },
        hideInterstitial: function () {
            this.interstitialScreen && c.removeClass(this.interstitialScreen, "show");
            this.hideCallback && (this.hideCallback(), this.hideCallback = null);
            this.dispatch(C.events.INTERSTITIALHIDDEN)
        },
        shouldShowInterstitial: function () {
            return false;
            // return this.enabled && g[this.getAdSlotName()] ? 0 === this.game.numPlays % 5 : !1
        },
        getAdSlotName: function () {
            return this.enabled ? c.isMobile.any() ? this.interstitialMobileSlotName : this.interstitialDesktopSlotName : null
        }
    });
    l.gravity =
        2500;
    l.cruisingOscPeriod = 800;
    l.cruisingOscHeight = 10;
    l.states = {
        cruising: "cruising",
        flapping: "flapping",
        stalling: "stalling",
    ...
    l.PI2 = 2 * Math.PI;
    l.prototype = c.inherit(new E, J.prototype, {
        setX: function (a) {
            this.x = a
        },
        setY: function (a) {
        ...
        isAlive: function () {
            return this.state !== l.states.flyingDead && this.state !== l.states.groundDead
        },
        update: function (a, b, c, d) {
            a = 0;
            switch (this.state) {
            case l.states.cruising:
                a = Math.floor(c / l.spriteSpeeds.cruising) % this.imgs.length;
                break;
            case l.states.flapping:
                a = Math.floor(c / l.spriteSpeeds.flapping) % this.imgs.length;
                break;
            case l.states.stalling:
            case l.states.flyingDead:
            case l.states.groundDead:
                a = this.stallingIndex
            }
            this.previousIndex !== a && (this.image = this.imgs[a], this.previousIndex = a);
            this.started ? (this.state !== l.states.groundDead && (this.speedY += l.gravity * b, this.x += this.speedX * b, this.y += this.speedY *
                b, 0 > this.y && (this.y = 0), this.rect.setPosition(this.x - this.rectWidth / 2, this.y - this.rectHeight / 2)), 200 <= this.speedY ? (this.angle += 4 * Math.PI / 3 * b, this.isAlive() && (this.state = l.states.stalling), this.angle > Math.PI / 2 && (this.angle = Math.PI / 2)) : 200 > this.speedY && (this.angle -= 3 * Math.PI * b, this.isAlive() && (this.state = l.states.flapping), this.angle < -Math.PI / 8 && (this.angle = -Math.PI / 8))) : this.state === l.states.cruising && (this.y = this.startY + Math.sin(c % l.cruisingOscPeriod * l.PI2 / l.cruisingOscPeriod) * l.cruisingOscHeight)
        },
        flap: function () {
            this.speedY = -700
        }
    });
    X.prototype = c.inherit(new s, J.prototype, {
        update: function (a, b, c, d) {
    ...
    d.prototype = c.inherit(new v, {
        init: function () {
            var a = r.get("initScreen");
            a && c.removeClass(a, "show");
            this.imgManager.addEventListener(z.events.imageLoad, c.bindFnc(this, this.imageLoaded));
            this.imgManager.addEventListener(z.events.allImagesLoad, c.bindFnc(this, this.allImagesLoaded));
            this.soundManager.addEventListener(F.events.soundLoad, c.bindFnc(this,
                this.soundLoaded));
            this.soundManager.addEventListener(F.events.allSoundsLoad, c.bindFnc(this, this.allSoundsLoaded));
            this.mouseManager.addEventListener(p.events.DOWN, c.bindFnc(this.buttonManager, this.buttonManager.onDown));
            this.mouseManager.addEventListener(p.events.MOVE, c.bindFnc(this.buttonManager, this.buttonManager.onMove));
            this.mouseManager.addEventListener(p.events.UP, c.bindFnc(this.buttonManager, this.buttonManager.onUp));
            this.mouseManager.addEventListener(p.events.DOWN, c.bindFnc(this, this.mouseDown));
            this.keyboardManager.addEventListener(B.events.DOWN, c.bindFnc(this, this.keyDown));
            this.appCacheManager.addEventListener(x.events.LOADNORMALLY, c.bindFnc(this, function (a) {
                this.imgManager.startLoading();
                this.soundManager.startLoading()
            }));
            this.appCacheManager.addEventListener(x.events.UPDATEPROGRESS, c.bindFnc(this, this.appCacheUpdateProgress));
            this.appCacheManager.addEventListener(x.events.UPDATEREADY, c.bindFnc(this, this.appCacheUpdateReady));
            c.makeUnselectable(r.get("mainCon"), !0);
            g.addEventListener("resize",
                c.bindFnc(this, this.windowResize));
            g.cards && cards.kik && (this.kikEnabled = !0);
            this.kikEnabled && (g.kik && kik.metrics && kik.metrics.enableGoogleAnalytics && kik.metrics.enableGoogleAnalytics(), g.kik && kik.browser && kik.browser.on && (kik.browser.on("background", c.bindFnc(this, function () {
                this.stopLoop()
            })), kik.browser.on("foreground", c.bindFnc(this, function () {
                this.restartLoop()
            }))));
            this.bindedResizeCanvas = c.bindFnc(this, this.resizeCanvas);
            G(this.bindedResizeCanvas, 100);
            this.resizeCanvas();
        ...
        setupDebug: function () {
            this.debugStuff.output = r.create("div", "debugOutput", "debugOutput");
            ...
            this.debugStuff.output.style.zIndex = Math.pow(2, 32) -
                1;
            ...
            this.debugStuff.frameCounter.style.zIndex = Math.pow(2,
                32) - 1;
            ...
            case d.states.playing:
                this.animManager.startAnim(new k({
                    ...
                    stepCallback: c.bindFnc(this, function (a) {
                        this.instructionsContainer.opacity = a
                    }),
                    endCallback: c.bindFnc(this,
                        function () {
        ...
        appCacheUpdateProgress: function (a) {
            a.data.lengthComputable ? a.data.loaded >= a.data.total ? this.updatePercentLoaded(a.data.loaded, a.data.total, "Refreshing:") : this.updatePercentLoaded(a.data.loaded, a.data.total, "Updating:") : this.updateNoPercent("Updating...")
        },
        appCacheUpdateReady: function (a) {
            this.updatePercentLoaded(1, 1,
                "Refreshing:")
        },
        checkLoaded: function () {
            var a = this.imgManager.imgLoaded,
                b = this.imgManager.imgCount;
            this.soundManager.enabled && (a += this.soundManager.soundsLoaded, b += this.soundManager.soundsCount);
        ...
        updatePercentLoaded: function (a, b, c) {
            a /= b;
            b = 100 * a;
            this.progressText.text = c ? c + " " + Math.floor(b) + "%" : Math.floor(b) + "%";
            this.progressBar.right = d.BASEWIDTH * a
        },
        updateNoPercent: function (a) {
        ...
        start: function () {
            if (!this.started) {
                ...
                this.flappySprites = [{
                    ...
                    sequence: [this.imgManager.get(d.IMGS.flappyYellow2), this.imgManager.get(d.IMGS.flappyYellow), this.imgManager.get(d.IMGS.flappyYellow3), this.imgManager.get(d.IMGS.flappyYellow)]
                }, {
                    base: this.imgManager.get(d.IMGS.flappyBlue2),
                    sequence: [this.imgManager.get(d.IMGS.flappyBlue3),
                        this.imgManager.get(d.IMGS.flappyBlue2), this.imgManager.get(d.IMGS.flappyBlue), this.imgManager.get(d.IMGS.flappyBlue2)
                    ]
                }, {
                ...
                this.mainMenuLogo = this.spriteSheet.getSprite("logo");
                ...
                this.mainMenuPlayButton = new m(c.inherit(c.cloneObject(this.spriteSheet.getSprite("play").options), {
                    id: "mainMenuPlayButton",
                    x: -128,
                    y: 107,
                    width: 256,
                    height: 143,
                    clickFunction: c.bindFnc(this,
                        this.playButtonPressed)
                }));
                this.buttonManager.addButton(this.mainMenuPlayButton);
                this.mainMenu.addChild(this.mainMenuPlayButton);
                this.mainMenuVersion = new M({
                    x: d.BASEWIDTH / 2,
                    y: 420,
                    textAlign: "right",
                    textBaseline: "bottom",
                ...
                this.instructionsContainer = new s({
                    x: d.BASEWIDTH / 2,
                    y: 290,
                    visible: !1,
                    opacity: 0
                ...
                this.instructionsBird = this.spriteSheet.getSprite("instructions");
                ...
                this.gameOverBoard.anchorX =
                    this.gameOverBoard.width / 2;
                this.stage.addChild(this.gameOverBoard);
                this.gameOverButtons = new s({
                    x: d.BASEWIDTH / 2,
                    y: 587,
                    visible: !1,
                    opacity: 0
                ...
                this.gameOverPlayButton = new m(c.inherit(c.cloneObject(this.spriteSheet.getSprite("play").options), {
                ...
                this.kikEnabled && (this.gameOverKikButton = new m(c.inherit(c.cloneObject(this.spriteSheet.getSprite("kik").options), {
                    id: "kikButton",
                    x: 5,
                    y: 0,
                    width: 256,
                ...
                if (!this.kikEnabled || this.kikEnabled && !c.isMobile.iOS())
//                            this.gameOverTweetButton = new m(c.inherit(c.cloneObject(this.spriteSheet.getSprite("tweetButton").options), {
//                    id: "gameOverTweetButton",
//                    x: -189,
//                    y: 160,
//                    width: 179,
//                    height: 75,
//                    clickFunction: c.bindFnc(this, this.shareTwitter)
//                })), this.buttonManager.addButton(this.gameOverTweetButton), this.gameOverButtons.addChild(this.gameOverTweetButton),
                            
//                            this.gameOverFBButton = new m(c.inherit(c.cloneObject(this.spriteSheet.getSprite("fbButton").options),
//                                                                                                                                                                              {
//                    id: "gameOverFBButton",
//                    x: 10,
//                    y: 160,
//                    width: 179,
//                    height: 75,
//                    clickFunction: c.bindFnc(this, this.shareFB)
//                }))
//                            ,
//                            this.buttonManager.addButton(this.gameOverFBButton),
//                            this.gameOverButtons.addChild(this.gameOverFBButton)
                            ;
                this.updateContext.scrollSpeed =
                    d.scrollSpeed;
        ...
        beginGame: function (a) {
            ...
            this.bird.angle = 0;
            this.bird.state = l.states.cruising;
        ...
        endGame: function () {
            var a;
            this.score > this.bestScore && (this.bestScore = this.score, Y.setCookie(d.BESTSCORECOOKIE, this.bestScore.toString(), d.BESTSCORECOOKIETTL));
            a = new Q({
                anims: [new k({
                    duration: 300,
...
//                Z(a, g.cordova ? "_blank" : "shareTwitterWindow", "width=480,height=480,scrollbars=yes,location=" + (g.cordova ? "yes" : "no"))
//            }
//        },
//        shareFB: function () {
//            if (this.state === d.states.end) {
//                var a =
//                    "https://" + (c.isMobile.any() ? "m" : "www") + ".facebook.com/sharer.php?",
//                    b = {
...
//                Z(a, g.cordova ? "_blank" : "shareFacebookWindow", "width=626,height=436,scrollbars=yes,location=" + (g.cordova ? "yes" : "no"))
//            }
//        },
        sendKik: function () {
            g.cards && cards.kik && kik.send({
                title: "I scored " +
                    this.score + " on Flappy Lives",
                text: "Can you beat me?",
                pic: "/imgs/Flappy_icon.png",
                data: {
                    score: this.score
                }
            })
    ...
    g.init = function () {
        c.paramStringToObject(g.location.search).desktopcheck && "/game.html" !== g.location.pathname && !c.isMobile.any() && (g.location.href = "/desktop.html");
        new d
    }
})(window);